...
(define-key my-map (kbd "d D") 'dap-disconnect)
(define-key my-map (kbd "d b") 'dap-breakpoint-toggle)
(define-key my-map (kbd "d B") 'dap-ui-breakpoints)
(define-key my-map (kbd "d c") 'dap-continue)
(define-key my-map (kbd "d e") 'dap-eval)
(define-key my-map (kbd "d i") 'dap-step-in)
(define-key my-map (kbd "d I") 'dap-ui-inspect)
(define-key my-map (kbd "d L") 'dap-ui-locals)
(define-key my-map (kbd "d n") 'dap-next)
(define-key my-map (kbd "d o") 'dap-step-out)
(define-key my-map (kbd "d O") 'dap-go-to-output-buffer)
(define-key my-map (kbd "d R") 'dap-repl)
(define-key my-map (kbd "d t") 'dap-switch-thread)
